...
class ARModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_data_loss", data_loss, on_step=True, on_epoch=True, prog_bar=True)
        self.log("train_phys_loss", phys_loss, on_step=True, on_epoch=True, prog_bar=True)
